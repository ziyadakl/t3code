...
import { CompletionNotificationsBootstrap } from "../notifications/CompletionNotificationsBootstrap";
import {
  ...
  return (
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        {primaryEnvironmentAuthenticated ? <CompletionNotificationsBootstrap /> : null}
