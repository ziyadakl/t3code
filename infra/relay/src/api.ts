...
import { withSpanAttributes, withUserId } from "./telemetry.ts";
...
function isRelayCommonPersistenceError(error: unknown): error is RelayCommonPersistenceError {
  return (
    ...
    error instanceof DpopProofs.DpopProofReplayPersistenceError ||
